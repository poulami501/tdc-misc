<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="//object[@objectID='72663fa49785']">
		<object class="com.zerog.ia.installer.util.VariablePropertyData" objectID="72663fa49785">
			<property name="propertyValue">
				<string><![CDATA[true]]></string>
			</property>
			<property name="propertyName">
				<string><![CDATA[$TNG$]]></string>
			</property>
		</object>
	</xsl:template>
	...
	<xsl:template match="//property[@name='installerName']">
		<property name="installerName">
			<string><![CDATA[InstallOAS_TERRANOVA3]]></string>
		</property>
	</xsl:template>
