 ...
 *
 */
public class LongComparisonRule extends CustomCodeRule {
	...
	public boolean evaluateRule() {
		...
		String strOperand1 = LongComparisonRule.ruleProxy.substitute("$ICR_OPERAND1$");
		String strOperand2 = LongComparisonRule.ruleProxy.substitute("$ICR_OPERAND2$");
		String strOperator = LongComparisonRule.ruleProxy.substitute("$ICR_OPERATOR$");

        if( (strOperand1 == null) && (strOperand2 == null) && (strOperator == null) ) {
            System.err.println("Long Comparison Rule: ignored!");            
            ...
            System.err.println("Long Comparison Rule: " + strOperand1 + " " + strOperator + " " + strOperand2);
			
            try {         
                long operand1 = Long.parseLong(strOperand1);
				long operand2 = Long.parseLong(strOperand2);

				if( strOperator.equalsIgnoreCase(LESS_THAN) ) {
					results = (operand1 < operand2);					
					System.out.println("Long Comparison Rule: " + strOperand1 + " < " + strOperand2 + " = " + results);
