	...
	public void run() {
		...
		try {
            ...
            if ( this.macOS ) {
                ...
                /*
                 * Changes for story GA Scientific and Graphing Calculators. Adding vanilla product check.
                 * */
                if(("OKLAHOMA".equals(productType)) || ("TASC".equals(productType)) || ("VANILLA".equals(productType))) {
                	this.startCmd[0] = javaHome + "java";
                	this.startCmd[1] = "-d32";
